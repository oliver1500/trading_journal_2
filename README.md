...
- `trades/` — one file per trade, named `NNN-YYYY-MM-DD-TICKER.md`
...
2. Copy `TEMPLATE.md` to `trades/NNN-YYYY-MM-DD-TICKER.md` and write the narrative
   while it's fresh — thesis, screenshots, what happened, lessons learned.
